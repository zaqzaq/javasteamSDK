...
public class ISteamUserStats {
   ...
   private static final ByteBuffer tempBuffer = ByteBuffer.allocateDirect(200).order(ByteOrder.nativeOrder());
   ...
   public static boolean GetAchievement(final String pchName) {
      ...
      tempBuffer.put(pchName.getBytes(StandardCharsets.UTF_8));
   ...
   public static void FindOrCreateLeaderboard(final String pchLeaderboardName,
         final ELeaderboardSortMethod eLeaderboardSortMethod,
   ...
   public static void DownloadLeaderboardEntries(final SteamLeaderboard_t hSteamLeaderboard,
         final ELeaderboardDataRequest eLeaderboardDataRequest,
         final int nRangeStart,
         final int nRangeEnd) {
   ...
   /**
    * Returns data about a single leaderboard entry use a for loop from 0 to LeaderboardScoresDownloaded_t::m_cEntryCount to get all the downloaded entries
    * e.g.
    * <pre>{@code
    *
    ...
    *    int32 details[3];
    * 	we know this is how many we've stored previously
    ...
    * @return
    */
   public static boolean GetDownloadedLeaderboardEntry(final SteamLeaderboardEntries_t hSteamLeaderboardEntries,
         final int index,
         final LeaderboardEntry_t pLeaderboardEntry,
         final IntBuffer pDetails) {
   ...
   private static native boolean nGetDownloadedLeaderboardEntry(long hSteamLeaderboardEntries,
         int index,
         LeaderboardEntry_t pLeaderboardEntry,
         IntBuffer pDetails);

   public static void UploadLeaderboardScore(final SteamLeaderboard_t hSteamLeaderboard,
         final ELeaderboardUploadScoreMethod eLeaderboardUploadScoreMethod,
         final int nScore,
         final IntBuffer pScoreDetails) {
   ...
   public static void FindOrCreateLeaderboard(final String pchLeaderboardName,
      ...
      nFindOrCreateLeaderboardListener(pchLeaderboardName, eLeaderboardSortMethod.toInt(), eLeaderboardDisplayType.toInt(), listener.getCppCallbackInstance());
   }

   private static native void nFindOrCreateLeaderboardListener(String pchLeaderboardName,
   ...
   public static void DownloadLeaderboardEntries(final SteamLeaderboard_t hSteamLeaderboard,
      ...
      nDownloadLeaderboardEntriesListener(hSteamLeaderboard.steamLeaderboard_t,
            eLeaderboardDataRequest.toInt(),
            nRangeStart,
            nRangeEnd,
            listener.getCppCallbackInstance());
   }

   private static native void nDownloadLeaderboardEntriesListener(long hSteamLeaderboard,
    ...
    * @param cUsers
    */
   public static void DownloadLeaderboardEntriesForUsers(final SteamLeaderboard_t hSteamLeaderboard,
         final CSteamID prgUsers,
         final int cUsers,
         final SteamUserStatsListener listener) {
      if (listener.getCppCallbackInstance() == 0) {
         throw new RuntimeException("SteamUserStatsListener was destroyed");
   ...
   public static void UploadLeaderboardScore(final SteamLeaderboard_t hSteamLeaderboard,
      ...
      nUploadLeaderboardScoreListener(hSteamLeaderboard.steamLeaderboard_t,
            eLeaderboardUploadScoreMethod.toInt(),
            nScore,
            pScoreDetails,
            listener.getCppCallbackInstance());
   }

   private static native void nUploadLeaderboardScoreListener(long hSteamLeaderboard,
